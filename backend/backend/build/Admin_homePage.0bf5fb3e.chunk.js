...
`,Fe=()=>{const{collectionTypes:t,singleTypes:a,isLoading:o}=(0,A.bP)(),{guidedTourState:l,isGuidedTourVisible:p,isSkipped:y}=(0,i.useGuidedTour)(),j=!z(l)&&p&&!y,{push:x}=(0,F.useHistory)(),M=s=>{s.preventDefault(),x("/plugins/content-type-builder/content-types/create-content-type")},u=(0,e.useMemo)(()=>{const s=Ve=>Ve.filter($e=>$e.isDisplayed);return s(t).length>1||s(a).length>0},[t,a]);return o?e.createElement(i.LoadingIndicatorPage,null):e.createElement(W.Layout,null,e.createElement(f.FormattedMessage,{id:"HomePage.helmet.title",defaultMessage:"Homepage"},s=>e.createElement(O.Helmet,{title:s[0]})),e.createElement(V.Main,null,e.createElement(Oe,null,e.createElement("img",{alt:"","aria-hidden":!0,src:$})),e.createElement(c.Box,{padding:10},e.createElement(g.Grid,null,e.createElement(g.GridItem,{col:8,s:12},e.createElement(Me,{onCreateCT:M,hasCreatedContentType:u}))),e.createElement(g.Grid,{gap:6},e.createElement(g.GridItem,{col:8,s:12},j?e.createElement(te,null):e.createElement(je,null)),e.createElement(g.GridItem,{col:4,s:12},e.createElement(ke,null))))))},We=(0,e.memo)(Fe)},42462:(L,T,n)=>{L.exports=n.p+"2a9e9ef5c4c775bb7c7b.png"}}]);
